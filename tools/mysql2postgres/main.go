...
func parseFlags(args []string) (config, error) {
	cfg := config{schema: "public", batchSize: 1000}
	...
	fs.StringVar(&cfg.schema, "schema", "public", "target PostgreSQL schema")
	...
	fs.IntVar(&cfg.batchSize, "batch-size", 1000, "rows per progress log")
